 ...
 */
$(function () {
    var diagram, flowcharts = $("div.diagram.flowchart");
    if (flowcharts.length) {
        ...
        $.each($("div.diagram.flowchart"), function(index, diagram) {
            var fn = "assets/" + diagram.id + ".diag";
